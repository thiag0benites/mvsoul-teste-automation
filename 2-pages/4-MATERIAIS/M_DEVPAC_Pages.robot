...
${CampoNome}                     xpath=(//div[@class="slick-cell b2 f2 selected"])[2]
${InputPaciente}                 xpath=//input[@class='editor-text mode-search']
${BotaoExecutar}                 xpath=//i[@class='mv-basico-confirmar']                
${BotaoConfirmar}                xpath=//button[@data-action='btnConfirmar_click']     #//button[@data-member='BTN_CONFIRMAR']
...
${CampoProdutoL2}                xpath=//input[@class='filterinput']
${BtnOK}                         xpath=
