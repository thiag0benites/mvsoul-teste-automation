...
Preenche Lancamentos do Lote "Historico Padrao|${HistPad}|", "Descricao Comp Padrao|${DescCompPad}|", "Cod Reduzido Debt|${CodRedDebt}|", "Cod Reduzido Cred|${CodRedCred}|", Valor Moeda|${VlMoeda}|"
