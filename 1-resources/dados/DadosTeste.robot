...
${dadosLoginSenhaQaDevelop}    12345678
${dadosLoginEmpresaQaDevelop}    5 - HOSPITAL MV - MATRIZ    - TESTES WATI
...
${dadosLoginUsuarioQaAutomacao}    USUARIOTESTADOR
${dadosLoginSenhaQaAutomacao}    123456789
${dadosLoginEmpresaQaAutomacao}    5 - HOSPITAL MV - MATRIZ
