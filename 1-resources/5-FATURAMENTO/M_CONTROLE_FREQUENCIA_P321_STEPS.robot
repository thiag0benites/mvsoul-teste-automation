...
Controle de frequencia individual
    ...
    Clicar no Campo e Preencher Informacao    ${CampoMesAno}                 ${CampoMesAno}                 022021
    ...
    Clicar no Campo e Preencher Informacao    ${DataInicial}                 ${DataInicial}                 21022021
    #Preencher Data final do tratamento
    Clicar no Campo e Preencher Informacao    ${DataFinal}                   ${DataFinal}                   22022021
