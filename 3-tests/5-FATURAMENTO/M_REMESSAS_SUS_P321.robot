...
# robot -v browser:chrome -t "SCR5FMSERVICOSIASUSURG-001:Fluxo principal" -d ./5-results/M_SERVICO_SIA_SUS_URG "3-tests/5-FATURAMENTO/M_REMESSAS_SUS_P321.robot"
# robot -v browser:firefox -t "SCR5FMSERVICOSIASUSURG-001:Fluxo principal" -d ./5-results/M_SERVICO_SIA_SUS_URG "3-tests/5-FATURAMENTO/M_REMESSAS_SUS_P321.robot"
