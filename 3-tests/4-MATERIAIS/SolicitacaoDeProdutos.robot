...
#################################################################################################################################################################
# Execução Exemplo:
# chrome:  robot -v browser:chrome -t "SCR4M-002:Solicitacao de Produtos" -d ./5-results/SCR4M-002 "3-tests/4-MATERIAIS/SolicitacaoDeProdutos.robot"
# firefox: robot -v browser:firefox -t "SCR4M-002:Solicitacao de Produtos" -d ./5-results/SCR4M-002"3-tests/4-MATERIAIS/SolicitacaoDeProdutos.robot"
#################################################################################################################################################################
# Execução modo headless (invisível)
# chrome:  robot -v browser:headlesschrome -d ./5-results/SCR4M-002 "3-tests/4-MATERIAIS/SolicitacaoDeProdutos.robot"
# firefox: robot -v browser:headlessfirefox -d ./5-results/SCR4M-002 "3-tests/4-MATERIAIS/SolicitacaoDeProdutos.robot"
#################################################################################################################################################################
*** Settings ***
