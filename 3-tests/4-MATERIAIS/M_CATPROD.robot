...
Resource          ../../1-resources/4-MATERIAIS/M_CATPROD_STEPS.robot
...
*** Test Case ***
SCR4MMCATPROD-001:Fluxo Principal
# robot -v browser:chrome -t "SCR4MMCATPROD-001:Fluxo Principal" -d ./5-results/SCR4MMCATPROD-001 "3-tests/4-MATERIAIS/M_CATPROD.robot"
# robot -v browser:firefox -t "SCR4MMCATPROD-001:Fluxo Principal" -d ./5-results/SCR4MMCATPROD-001 "3-tests/4-MATERIAIS/M_CATPROD.robot"
