...
# robot -v browser:firefox -t "SCR6MMCONREC-001:Fluxo Principal" -d ./5-results/SCR6MMCONREC-001 "3-tests/6-CONTROLADORIA/M_CON_REC.robot"
    ...
    Preencher Tipo de Documento, Cliente, Numero do Documento, Serie e Conta Contabil |${dados}[TpDocumento]| |${dados}[Cliente]| |${dados}[NrDocumento]| |${dados}[Serie]| |${dados}[ContaContabil]|
