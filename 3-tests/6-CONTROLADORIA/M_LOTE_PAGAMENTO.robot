...
SMF-5451 : Agrupar os titulos no Lote de Pagamento pesquisando por Data de vencimento
# robot -v browser:chrome -t "SMF-5451 : Agrupar os titulos no Lote de Pagamento pesquisando por Data de vencimento" -d ./5-results/SMF-5451 "3-tests/6-CONTROLADORIA/M_LOTE_PAGAMENTO.robot"
# robot -v browser:firefox -t "SMF-5451 : Agrupar os titulos no Lote de Pagamento pesquisando por Data de vencimento" -d ./5-results/SMF-5451 "3-tests/6-CONTROLADORIA/M_LOTE_PAGAMENTO.robot"
