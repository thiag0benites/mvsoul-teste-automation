...
#################################################################################################################################################################
# Execução Exemplo:
# chrome:         robot -v browser:chrome -d ./5-results/M_PGTO_REP_GERAL "3-tests\2 - ASSISTENCIAL\M_PGTO_REP_GERAL.robot"
# chrome:         robot -v browser:firefox -d ./5-results/M_PGTO_REP_GERAL "3-tests\2 - ASSISTENCIAL\M_PGTO_REP_GERAL.robot"
#################################################################################################################################################################
# Execução modo headless (invisível)
# chrome:         robot -v browser:headlesschrome -d ./5-results/M_PGTO_REP_GERAL "3-tests\2 - ASSISTENCIAL\M_PGTO_REP_GERAL.robot"
# chrome:         robot -v browser:headlessfirefox -d ./5-results/M_PGTO_REP_GERAL "3-tests\2 - ASSISTENCIAL\M_PGTO_REP_GERAL.robot"
#################################################################################################################################################################
*** Settings ***
...
# robot -v browser:firefox -t "SMF-7788 : Pagamento a Todos os Prestadores" -d ./5-results/SMF-7788 "3-tests/6-CONTROLADORIA/M_PGTO_REP_GERAL.robot"
    ...
    Inserir Data Competencia |01/Mai/2019|
