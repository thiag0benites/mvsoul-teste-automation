...
#################################################################################################################################################################
# Execução Exemplo:
# chrome:         robot -v browser:chrome -d ./5-results/O_CANC_MOV_CAIXA "3-tests\6-CONTROLADORIA\O_CANC_MOV_CAIXA.robot"
# chrome:         robot -v browser:firefox -d ./5-results/O_CANC_MOV_CAIXA "3-tests\6-CONTROLADORIA\O_CANC_MOV_CAIXA.robot"
#################################################################################################################################################################
# Execução modo headless (invisível)
# chrome:         robot -v browser:headlesschrome -d ./5-results/O_CANC_MOV_CAIXA "3-tests\6-CONTROLADORIA\O_CANC_MOV_CAIXA.robot"
# chrome:         robot -v browser:headlessfirefox -d ./5-results/O_CANC_MOV_CAIXA "3-tests\6-CONTROLADORIA\O_CANC_MOV_CAIXA.robot"
#################################################################################################################################################################
*** Settings ***
