...
#################################################################################################################################################################
# Execução Exemplo:
# chrome:         robot -v browser:chrome -d ./5-results/M_REP_MANUAL "3-tests\6-CONTROLADORIA\M_REP_MANUAL.robot"
# chrome:         robot -v browser:firefox -d ./5-results/M_REP_MANUAL "3-tests\6-CONTROLADORIA\M_REP_MANUAL.robot"
#################################################################################################################################################################
# Execução modo headless (invisível)
# chrome:         robot -v browser:headlesschrome -d ./5-results/M_REP_MANUAL "3-tests\6-CONTROLADORIA\M_REP_MANUAL.robot"
# chrome:         robot -v browser:headlessfirefox -d ./5-results/M_REP_MANUAL "3-tests\6-CONTROLADORIA\M_REP_MANUAL.robot"
#################################################################################################################################################################
*** Settings ***
...
# robot -v browser:firefox -t "SMF-6503 : Realizar o Lancamento Manual de Repasse Medico" -d ./5-results/SMF-6503 "3-tests/6-CONTROLADORIA/M_REP_MANUAL.robot"
    ...
    Inserir Data Repasse |${dados}[DataRepasse]|    ### PREENCHER dd/Mmm/aaaa ###
    ...
    Inserir Data Competencia |${dados}[DataCompetencia]|    ### PREENCHER dd/Mmm/aaaa ###
